...
WiFiClientSecure secret_client;
PubSubClient mqttClient(secret_client);
// PubSubClient mqtt_client(secret_client);

void connectMQTT() {
  secret_client.setCACert(root_ca);   // TLSの設定（ルート証明書のセット）
